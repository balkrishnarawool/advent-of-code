...
public class Problem11B {
    ...
    private static int countFlashes(String[] strs) {
    ...
    private static boolean synced(Octo[][] arr) {
        for (Octo[] octos : arr) {
            for (Octo octo : octos) {
                if (!octo.flashed) return false;
            }
        }
        return true;
    }
    ...
    public static void main(String[] args) {
        String[] input1 = fileToStringArray(Problem11B.class, "Problem11Input1.txt");
        String[] input2 = fileToStringArray(Problem11B.class, "Problem11Input2.txt");

        System.out.println(countFlashes(input1));
        System.out.println(countFlashes(input2));
