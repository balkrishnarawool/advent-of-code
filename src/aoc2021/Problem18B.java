...
public class Problem18B {
    ...
    private static void solve(String[] input) {
        ...
        for (String s : input) {
            for (String s2 : input) {
                if (!s.equals(s2)) {
                    long t = magnitude(add(toList(s), toList(s2)));
                    max = Math.max(max, t);
                }
            }
        }
    ...
    public static void main(String[] args) {
        String[] input1 = fileToStringArray(Problem18B.class, "Problem18Input1.txt");
        String[] input2 = fileToStringArray(Problem18B.class, "Problem18Input2.txt");
